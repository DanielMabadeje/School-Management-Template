...
<head>
  ...
  <link rel="stylesheet" href="dist/css/skins/skin-green.min.css">
        ...
        <link id="browser_favicon" rel="shortcut icon" href="<?php echo PREPEND_PATH; ?>resources/images/ru_logo.jfif">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><img src="<?php echo PREPEND_PATH; ?>resources/images/ru_logo.jfif" height="auto" alt=""></span>
    </a>
